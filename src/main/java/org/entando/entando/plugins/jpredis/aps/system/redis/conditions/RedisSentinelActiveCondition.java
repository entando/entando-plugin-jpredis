...
public class RedisSentinelActiveCondition implements Condition {

    private final boolean envActive;

    public RedisSentinelActiveCondition() {
        this(RedisEnvironmentVariables.sentinelActive());
    }

    protected RedisSentinelActiveCondition(boolean active) {
